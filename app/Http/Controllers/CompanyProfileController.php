...
class CompanyProfileController extends Controller
{
    ...
    private function validated(Request $request): array
    {
        ...
        return $request->validate([
            ...
            'delivery_gap_alert_amount' => ['required', 'numeric', 'min:0', 'max:999999999'],
            'received_not_invoiced_alert_amount' => ['required', 'numeric', 'min:0', 'max:999999999'],
    ...
    private function mergeMissingGlobalDefaults(Request $request): void
    {
        ...
        foreach (['country', 'timezone', 'base_currency', 'currency_display', 'currency_symbol_override', 'date_format', 'number_format', 'tax_label', 'tax_registration_label', 'default_tax_rate', 'delivery_gap_alert_percent', 'received_not_invoiced_alert_percent', 'delivery_gap_alert_amount', 'received_not_invoiced_alert_amount'] as $field) {

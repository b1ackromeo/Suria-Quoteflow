...
class DocumentConversionService
{
    ...
    private function targetAttributes(Document $source, array $targetMeta, int $userId): array
    {
        ...
        return [
            ...
            'retention_percent' => $targetType === 'goods_receipt' ? null : $source->retention_percent,
            'retention_amount' => $targetType === 'goods_receipt' ? null : $source->retention_amount,
            'retention_release_date' => $targetType === 'goods_receipt' ? null : optional($source->retention_release_date)->toDateString(),
